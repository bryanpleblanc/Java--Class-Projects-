 ...
 * 
 * A custom JDialog that we supply and that you can optionally use as part of the GUI.
 * 
 * @author Jo Perry and Bryan LeBlanc
 *
 */
...
public class Edit extends JDialog {
    ...
    private final static String[] INFO_LABELS = {"Service Tier"};
